...
sudo dnf config-manager addrepo --from-repofile=https://download.opensuse.org/repositories/network:im:signal/Fedora_$FEDORA_VERSION/network:im:signal.repo
